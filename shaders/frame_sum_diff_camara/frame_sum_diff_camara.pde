...
PGraphics bufferDiff, frameAnterior,sumDiff;
PShader shaderDiff,shaderSum; //prefiero procesar las imgs en GPU 
...
void draw() {
  ...
  if (cam.available()) {
    ...
    image(frameAnterior, width/2, 0, width/2, height/2);
