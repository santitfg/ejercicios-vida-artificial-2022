...
PGraphics bufferDiff, frameAnterior, sumDiff, bufferBlur, bufferMult;
PShader shaderDiff, shaderSum, blur, shaderMult; //prefiero procesar las imgs en GPU 
...
void draw() {
  ...
  image(bufferMult, width/2, 0, width/2, height/2);
